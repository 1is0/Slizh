...
namespace Footballers
{
    class Program
    {
        public static Footballer EnterPlayer()
        {
            ...
            Console.WriteLine("Enter Weight[20,300]:");
            player.Weight = CheckOfWeight();
            ...
            Console.WriteLine("Enter FIFA rating[45,89]:");
        ...
        public static int CheckOfWeight()
        {
            int a;
            while (!int.TryParse(Console.ReadLine(), out a) || a <= 20 || a >= 300)
        ...
        {
            int a;
            while (!int.TryParse(Console.ReadLine(), out a) || a <= 45 || a >= 89)
                Console.Write("Incorrect input, repeat: ");
            return a;
        }
      ...
      /*  static void Coping()
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("=>Press enter");
            Console.Clear();
            Console.WriteLine("Do you want to train your footballers?");
            Console.WriteLine("1-Yes, 0-No");
            int tmp = YesNoCheck();
            
                if (tmp == 1)
                {
                    Console.WriteLine("Choose the footballer who you want to train.");
                    int foot = Convert.ToInt32(Console.ReadLine());
                    arr[foot - 1].EndWork += delegate
                    {
                        Console.WriteLine("Now your fifa rating" + arr[foot - 1].qual.fifaRate);
                        Console.WriteLine("Now your weight " + arr[foot - 1].Weight);
                    };
                    arr[foot - 1].Training();
                ...
                Console.WriteLine("Do u want to train another player");
                Console.WriteLine("1-yes 0-no");
                tmp = YesNoCheck();
                if (tmp == 1)
                {
                ...
                {
                    Console.WriteLine("Incorrect choosing of player");
                }
